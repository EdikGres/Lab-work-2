...
/*
	Для того чтобы протестировать main(), мне нужно сделать отдельную его функцию и просто её тестировать. А чтобы сделать ту функцию, нужно научить возвращать массив. В ПРОЦЕССЕ ОБУЧЕНИЯ.
